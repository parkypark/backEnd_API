...
class ScheduleTestingController extends BaseController {
  public function colours($department)
  {
    $sql = '
      SELECT DISTINCT S.Color AS colour, C.description
      FROM production_test.schedules AS S
  ...
  {
    $sql = 'SELECT DISTINCT Department FROM production_test.schedules WHERE LENGTH(Department) > 0';
  ...
  public function details($department)
  {
    ...
    $data = DB::connection('archdb-wm')->select(DB::raw('CALL production_app_test.sp_GetScheduleDetails(?, ?, ?, ?, ?);'), [
      $department,
      $category1,
      $category2,
      $category3,
  ...
  public function subdepartments()
  {
    $sql = '
      ...
      FROM production_test.schedules
  ...
  public function headers($department)
  {
    ...
    $sql = 'CALL production_app_test.sp_GetScheduleHeaders(?, ?, ?, ?);';
  ...
  public function updateCompleted()
  {
    ...
    return Response::prettyjson($completed);
